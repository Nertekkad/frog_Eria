...
Treatment1<-which(components(ml_BTad_sp[[2]])$membership == which(components(ml_BTad_sp[[2]])$csize>=5))
Control<-which(components(ml_BTad_sp[[3]])$membership == which(components(ml_BTad_sp[[3]])$csize>=5))
...
Treatment1<-which(components(ml_BMet_sp[[2]])$membership == which(components(ml_BMet_sp[[2]])$csize>=5))
Control<-which(components(ml_BMet_sp[[3]])$membership == which(components(ml_BMet_sp[[3]])$csize>=5))
...
Treatment1<-which(components(ml_BAdl_sp[[2]])$membership == which(components(ml_BAdl_sp[[2]])$csize>=5))
Control<-which(components(ml_BAdl_sp[[3]])$membership == which(components(ml_BAdl_sp[[3]])$csize>=5))
